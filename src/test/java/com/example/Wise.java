    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try {
                ...
                WebElement timeDropdown = driver.findElement(By.xpath("//div[@role='combobox']")); // ***ADJUST LOCATOR IF NEEDED***
                ...
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("v-menu__content"))); // ***ADJUST LOCATOR IF NEEDED***
                ...
                try { // Try to select the time, but skip if not found
                    ...
                    WebElement timeToSelect = driver.findElement(By.xpath("//li[contains(.,'10:00')]")); // ***ADJUST LOCATOR IF NEEDED***
            ...
            } catch (NoSuchElementException | TimeoutException | AssertionError e) { // Correct Exception types
                System.err.println("Time selection/Create interaction failed: " + e.getMessage());
                System.out.println("Page Source at failure:\n" + driver.getPageSource()); // Crucial!
                e.printStackTrace();
            ...
            } catch (NoSuchElementException | TimeoutException e) { // Correct Exception types
